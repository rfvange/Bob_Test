...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->exitToolStripMenuItem->Size = System::Drawing::Size(104, 26);
...
//friend: ValidateKeyPress(System::String^ sControlText);
//friend int ValidateKeyPress(System::String^ sControlText);
